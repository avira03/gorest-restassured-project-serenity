...
public class UserCRUDTest extends TestBase {
    static String name = TestUtils.getRandomValue() + "Shiya";
    static String email = TestUtils.getRandomValue() + "shiya10@gmail.com";
    ...
    @Test
    public void test003() {
        name = "Radha" + TestUtils.getRandomValue();
        email = "Radha10@gmail.com" + TestUtils.getRandomValue();
